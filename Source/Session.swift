...
open class Session {
    ...
    // AlamofireNotifications 会在每个事件发生的时候, 发送对应的通知.
    ...
    public convenience init(configuration: URLSessionConfiguration = URLSessionConfiguration.af.default,
        ...
        // 在这里, 将 URLSession 和 delegate 进行了链接.
        // 而 Delegate 又通过协议, 和 Session 进行了链接.
    ...
    // 不一定, 非要使用特定的 Model.
    // 在对应的场景里面, 进行自己的 Model 或者 Struct 的构建, 其实是一个良好的设计. 
