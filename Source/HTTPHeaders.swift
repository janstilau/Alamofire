...
/*
 ...
 扩展性和自定义功能：通过使用专门的结构体，你可以为 HTTP 头部管理添加更多定制的功能，如特定的验证、格式化或其他处理逻辑，这些在普通字典中不容易实现。
 符合语义：使用 HTTPHeaders 类型比普通字典更能明确地表达代码的意图，提高了代码的可读性和维护性。
...
// 这里是一顿的静态工厂方法, 用于快速进行 Header 的构造的.
...
extension Array where Element == HTTPHeader {
    ...
    func index(of name: String) -> Int? {
        // Case-insensitively Find. 是需要专门实现的.
